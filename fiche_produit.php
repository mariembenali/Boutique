    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel-default border">
            ...
            <div class="panel-body">
                ...
                <p class="text-center">Prix : <?= number_format($prix, 2, ',', ' ') ?> €</p>
                <hr>

                <?php if ($stock > 0): ?>

                    <em>Nombre de produit(s) disponible : <?= $stock ?></em>
                    <hr>
                    <form method="post" action="">
                        ...
                        <input type="submit" name="ajout_panier" class="btn btn-primary col-md-12"
